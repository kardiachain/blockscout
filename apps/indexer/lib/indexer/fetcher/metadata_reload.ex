defmodule Indexer.Fetcher.MetadataReload do
  @moduledoc """
  Update information of existed NFT metadata
  """
  ...
  @defaults [
    ...
    max_batch_size: 1,
    max_concurrency: 2,
    task_supervisor: Indexer.Fetcher.MetadataReload.TaskSupervisor
  ]
  ...
  def init(initial_acc, reducer, _) do
    {:ok, acc} =
      Chain.stream_exist_token_instances(initial_acc, fn data, acc ->
        reducer.(data, acc)
      end)
